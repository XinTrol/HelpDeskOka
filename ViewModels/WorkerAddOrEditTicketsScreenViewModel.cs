...
namespace DiplomHelpDeskOka.ViewModels
{
    public partial class WorkerAddOrEditTicketsScreenViewModel : ViewModelBase
    {
        ...
        // Работник не может менять название и описание
        ...
        public bool IsTypeEnabled => true;
        public bool IsDepartmentEnabled => true;
        public bool IsPriorityEnabled => true;
        public bool IsStatusEnabled => true;
        public bool IsResponsibleUserEnabled => true;
        public bool IsPlannedDateEnabled => true;
        ...
        private async Task Save()
        {
            ...
            if (IsEditMode)
            {
                ...
                // Работник НЕ меняет Title и Description
                // ticket.Title = TicketTitle;  // закомментировано
                // ticket.Description = Description; // закомментировано
